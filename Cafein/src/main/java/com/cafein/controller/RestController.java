...
public class RestController {
	...
	public void productStockPrint(HttpServletResponse response) throws Exception {
		// 1. 테이블 데이터를 가져옵니다.
		List<QualityVO> list = sService.stockListExcel(); // 서비스에서 리스트로 받아서 List<VO> 형태로 넣어주세요.
	...
	public void materialStockPrint() throws Exception {
