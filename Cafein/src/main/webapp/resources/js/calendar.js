 ...
 */
 ...
 $(function() {
	 ...
	 //========================== 지시 조회 달력 시작 (start, end) ============================
       ...
       //========================== 지시 조회 달력 끝 (start, end) ============================ 
      
       //========================= 모달창 달력 시작 ==========================================
       // 모달창 달력 현재날짜부터 선택 가능하게 설정
       var now_utc = Date.now(); // 현재 날짜를 밀리초로
       var timeOff = new Date().getTimezoneOffset() * 60000; // 분 단위를 밀리초로 변환
       var today = new Date(now_utc - timeOff).toISOString().split("T")[0];

       //id="floatingInput"
       document.getElementById("floatingInput").setAttribute("min", today);


       // class="date"인 모든 요소에 날짜 비활성화
       document.querySelectorAll('.modalCal').forEach(function(input) {
