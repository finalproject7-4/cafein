			...
			<form action="/information/members" method="get">
				<div class="input-group mb-3">
					<select name="option" class="form-select mb-3" aria-label="Default select example">
						...
						<button class="btn btn-dark m-2" type="submit"
								style="background-color: #610B0B; border-color: #FBF8EF;">조회</button>
				</div>
			</form>
		</div>
	</div><br>	
		...
		<div class="bg-light rounded h-100 p-4">
			...
			<span style="margin-left: 82%;">
				<button type="button" class="btn btn-dark m-2"
				 		data-bs-toggle="modal" data-bs-target="#memberJoinModal" data-bs-whatever="@getbootstrap"
				 		style="background-color: #610B0B; border-color: #FBF8EF;">직원 등록</button>
			</span>
							...
							<tr>
								...
								<td>
									<button type="button" class="btn btn-outline-dark" 
											data-bs-toggle="modal" data-bs-target="#memberUpdateModal" data-bs-whatever="@getbootstrap"
									...
									<button type="button" class="btn btn-outline-dark" 
											data-bs-toggle="modal" data-bs-target="#memberDeleteModal" data-bs-whatever="@getbootstrap"
...
<script type="text/javascript">
	...
	// 직원 등록 모달
	var memberJoinModal = document.getElementById('memberJoinModal')
	memberJoinModal.addEventListener('show.bs.modal', function (event) {
  		var button = event.relatedTarget
  		var recipient = button.getAttribute('data-bs-whatever')
  		var modalTitle = memberJoinModal.querySelector('.modal-title')
 	 	var modalBodyInput = memberJoinModal.querySelector('.modal-body input')
	})
	
	// 직원 수정 모달
	function memberUpdateModal(memberid, membercode, memberpw, membername, memberbirth, memberhire, 
								departmentname, memberposition, memberemail, memberdeptphone, memberphone, available) {
	...
	// 직원 삭제 모달
	function memberDeleteModal(memberid2, membercode2, membername2, memberbirth2, memberhire2, 
								departmentname2, memberposition2, memberemail2, memberdeptphone2, memberphone2) {
