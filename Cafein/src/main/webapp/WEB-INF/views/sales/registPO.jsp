		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<input autocomplete="off"  id="itemid" name="itemname" class="form-control mb-3" type="text" placeholder="품목명/코드(클릭)" aria-label="default input example" required="required">
					...
					담당자
					<input autocomplete="off" name="membercode" class="membercode2 form-control mb-3" type="number" placeholder="담당자" required="required" value="${sessionScope.membercode}">
					</div>
